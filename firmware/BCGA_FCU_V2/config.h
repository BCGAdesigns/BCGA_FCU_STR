...
// VARIANT
// ============================================================================
// Comment out to build the Starter (perfboard) variant.
// BCGA_PRO enables: battery sense, WiFi button, kill latch, MOS_2 (poppet).
#define BCGA_PRO

// ============================================================================
// FIRMWARE METADATA
// ============================================================================
#define FW_NAME     "BCGA FCU V2"
...
// Outputs
#define PIN_MOS_1    8   // MOSFET 1 — Nozzle solenoid (also onboard LED, inverted)
#ifdef BCGA_PRO
  #define PIN_MOS_2   7   // MOSFET 2 — Poppet solenoid
...
// WIFI
// ============================================================================
// SSID matches the variant; password is fixed default until user changes via UI
#define WIFI_SSID_DEFAULT   FW_VARIANT_FULL   // BCGA_FCU_PRO or BCGA_FCU_STR
...
// triggered). With this defined, plugging in power immediately brings up the AP
// — useful for benchtop development without the WiFi button (Pro) or gesture
// (Starter). The 10-min idle auto-off still applies.
