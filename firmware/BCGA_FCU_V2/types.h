...
// FireMode now embeds the burst count directly. There is no separate
// AutoMode/burstCount any longer — Pos-N dropdown picks one of these.
...
enum SystemState : uint8_t {
  ...
  SYS_WIFI_ON,
  SYS_LOW_BATT,
  SYS_CUT          // Battery latch killed — Pro only
};
